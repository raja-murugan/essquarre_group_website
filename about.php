			...
			<div class="header-cta-btn-wrapper d-flex align-items-center">
				...
				<div class="header-cta-number d-flex align-items-center text-uppercase">
					...
					<div class="header-cta-value">
						...
						<span class="ar-value"><a href="tel:+91984179190">+91 984179190</a></span>
					</div>
				</div>
				<div class="header-cta-btn">
					<a class="d-flex justify-content-center align-items-center" href="https://api.whatsapp.com/send/?phone=%2B91984179190&text&type=phone_number&app_absent=0" target="_blank">Chat on Whatsapp<i class="fal fa-long-arrow-right"></i></a>
				</div>
			</div>
							...
							<div class="content-box">
								<h5>Contact Us</h5>
									<p class="text">
										...
										<a href="tel:+91984179190">+91 984179190</a><br>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-3 col-md-6">
						<div class="arck-footer-widget headline ul-li-block pera-content">
							<div class="contact-cta-widget">
								<h3 class="widget-title">C . Office</h3>
								<div class="contact-cta-item">
									<ul>
										...
										<li>
											<i class="fal fa-phone-alt"></i>
										<li><a href="tel:+910444261538">0444261538</a></li>
										</li>
										<li>
											<i class="fas fa-envelope"></i>
											<a
												href="mailto:Essquarreassociates@gmail.com">Essquarreassociates@gmail.com</a>
										</li>
									</ul>
								</div>
							</div>
					...
					<div class="col-lg-3 col-md-6">
						<div class="arck-footer-widget headline ul-li-block pera-content">
							<div class="contact-cta-widget">
								<h3 class="widget-title">B . Office</h3>
								<div class="contact-cta-item">
									<ul>
										<li>
											<i class="fas fa-map-marker-alt"></i>
										...
										<li>
											<i class="fal fa-phone-alt"></i>
										<li><a href="tel:+9104314505150">04314505150</a></li>
										</li>
										<li>
											<i class="fas fa-envelope"></i>
											<a href="mailto:info.essquarre@gmail.com">info.essquarre@gmail.com</a>
